...
<section class="wrap quiet-cta"><div><h2>ブログを読んでくださった方へ</h2><p>現場業向けHP制作を、<strong>ブログ読者価格 250,000円（税込）</strong>でご案内しています。通常価格は300,000円（税込）です。</p><small>お問い合わせ時に「ブログを見た」とお伝えください。</small></div><a class="text-link hp-service-link" href="https://construction-web-terra.com/?ref=jiriki-blog#contact">HP制作の内容を見る →</a></section></main>${footer('./')}`;
